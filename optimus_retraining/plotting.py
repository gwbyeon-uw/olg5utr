...
def plot_optimization_results(result) -> None:
    """Plot optimization history across MRL, protein, and edit metrics.

    Args:
        result: An ``OptimizationResult`` instance with a non-empty ``history``
            attribute. Each history entry is a list of
            ``[mrl1, mrl2, loss_prot, num_diff, loss_edit]``.
    """
    ...
    _fig, axes = plt.subplots(3, 2, figsize=(12, 10))
